...
Serverless frontend hosted on GitHub Pages. No backend, no Node.js runtime. Pure HTML5 + CSS3 + Vanilla JS + Ethers.js v6.
...
| Font Mono | JetBrains Mono (addresses, values) |
